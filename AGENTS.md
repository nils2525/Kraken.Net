...
Package id: `KrakenExchange.Net`. Main namespace/client name: `Kraken.Net`. Current repository package version: 8.3.0. Targets netstandard2.0, netstandard2.1, net8.0, net9.0, and net10.0. Native AOT is supported.
